...
include_v_shift    = 0; % 0: not plot velocity shift in resultant figures
                        % 1: include.
save_figures    = 0;    % 0: don't save, but pause after each treatment
                        % 1: save, no pause.
save_filt_feature= 0;   % 0: apply filter 
...
for i = 1:Nopos
    ...
    marked_list    = extractLongestConsecutiveMarkedCycles(marked_list,16);
                     % avg freq ~50, each cyc lasts 12 frame for c17l. 16
