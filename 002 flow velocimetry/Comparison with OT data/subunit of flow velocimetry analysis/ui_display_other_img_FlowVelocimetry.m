...
% version slightly modified to incorporate file names such as
% 1_0001_done.tif, 20170803
% 

function [next_img_button,...
          prev_img_button] = ui_display_other_img_FlowVelocimetry(...
                               img_fdpth,file_name,...
                               format_str,NextButtPos,...
                               PrevButtonPos)

next_img_button = uicontrol('Style','Pushbutton','String','Next Img',...
                  'Units','normalized','Position',NextButtPos,...
                  'Fontsize',15,'FontWeight','bold','BackgroundColor','w',...
                  'Callback',{@next_img,img_fdpth,file_name,format_str});

prev_img_button = uicontrol('Style','Pushbutton','String','Previous Img',...
    ...
    if current_img_idx > 1 
        ...
        previous_img_path = fullfile(img_fdpth,[file_name,'_',...
                            num2str(1,format_str),'_done.tif']);
        previous_img      = imread(previous_img_path);
    end
